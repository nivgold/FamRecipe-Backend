-- Niv personal 1
INSERT INTO [dbo].[personal_recipe] ([user_id], [image], [title], [ready_in_minutes], [popularity], [vegetarian], [vegan], [gluten_free], [ingredients_json_array], [instructions_json_array], [meals])
VALUES (
